...
public:
	...
	Table(short left, short top, const vector<int> &heightLines, const vector<int> &widthColumns, char symbol, const vector<vector<string>> &date, vector<function<string (short, short, bool, bool, string)>> inspections);
...
private:
    ...
    vector<function<string(short, short, bool, bool, string)>> inspections;
    const int left;
    const int top;
